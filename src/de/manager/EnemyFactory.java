...
public class EnemyFactory {
	...
	private void Init()
	{
		...
		Enemy[] enemies = {
				...
				new Enemy("아이언골렘", 400, 100, 60, 0, 0, 20, 0, 0, 100, 10, new Skill_AG(), "강철 투구", "반역자의 방패"), //던전1 네임드몹
				new Enemy("다크엘프도적", 300, 150, 0, 80, 0, 0, 10, 0, 120, 12, new Skill_BW(), "뇌신검"), //던전2 네임드몹
				new Enemy("해골저격병", 300, 150, 0, 80, 0, 0, 10, 0, 120, 12, new Skill_ST(), "달의 석궁", "저격수의 장갑"), //던전3 네임드몹
				new Enemy("에틴", 600, 150, 70, 0, 0, 10, 0, 0, 200, 20, new Skill_AV(), "영웅의 장검", "에틴의 흉기"), //던전4 네임드몹
				new Enemy("불타는궁수", 500, 250, 0, 90, 0, 0, 10, 0, 250, 25, new Skill_ST(), "악운의단검"), //던전5 네임드몹
				new Enemy("장로", 400, 400, 0, 0, 100, 0, 0, 10, 300, 30, new Skill_CL(), "장로의 손길"), //던전6 네임드몹
				new Enemy("흑장로", 400, 400, 0, 0, 120, 0, 0, 10, 300, 30, new Skill_CON(), "불꽃의 오브", "흑마법사 모자", "흑장로 로브"), //던전7 네임드몹
				new Enemy("네크로맨서", 600, 600, 0, 0, 130, 0, 0, 10, 400, 40, new Skill_CT(), "네크로맨서의 지팡이"), //던전8 네임드몹
				...
				new Enemy("풍령왕", 1400, 700, 0, 180, 0, 10, 40, 10, 1200, 120, new Skill_ST(), "엘프의 바람", "파괴의 장궁", "풍령왕의 신속"), //던전3 보스몹
